...
<div id="Wrapper">
	...
	<div id="Subheader" style="padding-top: 30px;">		<div class="container">			<div class="column one">				<h1 class="title">GALERIA & EVENTOS</h1>			</div>		</div>	</div>	</header>
<br/>
	<!-- #Content -->
	<div id="Content">		<div class="content_wrapper clearfix">			<!-- .sections_group -->			<div class="sections_group">				<div class="section">					<div class="section_wrapper clearfix">						<div class="column one column_portfolio">							<div class="portfolio_wrapper isotope_wrapper">							<hr/>								<ul class="portfolio_group one">																																		<!-- galeria e eventos -->									<li class="portfolio-item category-wordpress-themes">									<div class="photo">										<a class="photo-wrapper" href="#"><img width="815" height="543" src="upload/1-815x543.jpg" class="scale-with-grid wp-post-image" alt="1"/></a>									</div>									<div class="desc">										<div class="categories">											<a href="#">SETEMBRO 2015</a>										</div>										<h3>Sipats, feiras, semanas de saúde, campanhas de conscientização, promoção a saúde. Ações temáticas e outros.</h3>										<hr class="hr_left"/>										<div class="desc-wrapper">											<a href="album_01.php" class="button  "><i class="icon-camera"></i> VER ÁLBUM</a>										</div>									</div>									</li>									<!-- // galeria e eventos -->																		<!-- galeria e eventos -->									<!--<li class="portfolio-item category-wordpress-themes">									<div class="photo">										<a class="photo-wrapper" href="#"><img width="815" height="543" src="upload/1-815x543.jpg" class="scale-with-grid wp-post-image" alt="1"/></a>									</div>									<div class="desc">										<div class="categories">											<a href="#">AGOSTO 2015</a>										</div>										<h3><a href="album_01.php">SIPAT • COMETAIS</a></h3>										<hr class="hr_left"/>										<div class="desc-wrapper">											<h6>• PROJETO ABELHA HONDA</h6>											<p>												Suspendisse turpis et odio. Vestibulum aliquam odio. Nunc at sapien. Aliquam eleifend, ligula. Etiam rutrum, enim ac imperdiet sagittis, elit.												Suspendisse turpis et odio. Vestibulum aliquam odio. Nunc at sapien. Aliquam eleifend, ligula. Etiam rutrum, enim ac imperdiet sagittis, elit.											</p>											<a href="album_01.php" class="button  "><i class="icon-camera"></i> VER ÁLBUM</a>										</div>									</div>									</li>-->									<!-- // galeria e eventos -->																										</ul>																								<!--<div class="column one pager_wrapper">									<div class="pager">										<a href="#" class="page active">1</a>										<a href="#" class="page">2</a>										<a class="next_page" href="#">										<i class="icon-right-open"></i></a>									</div>								</div>-->																							</div>						</div>					</div>				</div>				<div id="Subheader" style="padding-top: 30px;">					<div class="container">						<div class="column one">							<h1 class="title">Voce não é nosso cliente?</h1>							<hr class="hr_left"/>							<p>Consulte nossos orçamentos para desenvolver tudo isso e muito mais na sua empresa.</p>							<div class="desc-wrapper">								<a href="contato.php" class="button  "><i class="icon-user"></i> QUERO ME TORNAR UM CLIENTE</a>							</div>						</div>					</div>				</div>			</div>			<!-- .four-columns - sidebar -->		</div>	</div>
